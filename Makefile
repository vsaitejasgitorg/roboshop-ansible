...
all:
	...
	ansible-playbook -i redis-dev.saitejasroboshopstoree, -e ansible_user=ec2-user -e ansible_password=DevOps321 roboshop.yml -e component_name=redis -e env=$(env)
...
#This Command executes configuration of all servers at once